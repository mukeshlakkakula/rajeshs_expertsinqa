  ...
  return (
    <section className="py-32 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10 text-center">
        ...
        <Link
          href="/contact"
          className="inline-flex items-center justify-center w-40 h-40 md:w-56 md:h-56 rounded-full bg-foreground text-white group hover:bg-brand hover:text-black transition-all duration-700 relative"
        >
